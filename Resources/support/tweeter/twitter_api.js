...
var TwitterApi = function(params){
  ...
  this.init = function(callback){
    ...
    var config = oAuthAdapter.loadAccessToken('twitter');
    if (oAuthAdapter.isAuthorized() == false) 
    {
      var receivePin = function() {
        oAuthAdapter.getAccessToken('https://api.twitter.com/oauth/access_token', function(resp){
